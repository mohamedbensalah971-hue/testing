...
EOF
                                ...
                                if (response.contains('"success": true') || response.contains('"success":true')) {
                                    ...
                                    try {
                                        ...
                                        if (jsonResponse.generated_tests) {
                                            ...
                                            writeFile file: testFilePath, text: jsonResponse.generated_tests
                                            ...
                                            sh """
                                                ...
                                                git commit -m "test: Add ${testFileName} (Auto-generated by Agent IA - confidence: ${jsonResponse.confidence})" || echo "Rien à committer"
                                            """
                                            
                                            echo "✅ Test commité automatiquement"
                                            
                                            // NOUVEAU: Push automatique vers GitHub
                                            try {
                                                sh """
                                            ...
                                            echo "📊 Confiance: ${jsonResponse.confidence}"
                                            echo "📊 Tokens utilisés: ${jsonResponse.tokens_used}"
                                            echo "📊 RAG utilisé: ${jsonResponse.rag_context_used}"
                                            
                                        } else {
                                            echo "⚠️  Pas de code de test dans la réponse"
                                        }
